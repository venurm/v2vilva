        ...
        <div class="col-lg-12 col-md-12">
            <div class="clients-list clients-border column-5">
                <ul class="list-unstyled">
                    <li>
                        <img class="img-fluid mx-auto" src="{{ asset('assets/images/clients/haodapay.webp') }}" alt="HaodaPay">
                    </li>
                     <li>
                        <img class="img-fluid mx-auto" src="{{ asset('assets/images/clients/thaithingal.webp') }}" alt="Thaithingal">
                    </li>
                    <li>

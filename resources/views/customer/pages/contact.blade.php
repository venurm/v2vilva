      ...
      <div class="container-contact d-block d-md-flex container">
          ...
          <div class="form-wrapper">
            ...
            <div class="input-wrap">
              ...
              <div class="input-wrap" w-100>
                ...
                <i class="icon fa-solid fa-envelope" style="color:#007E60;"></i>
              </div>
              ...
              <div class="input-wrap">
                ...
                <i class="icon fa-solid fa-mobile" style="color:#007E60;"></i>
              </div>

              <div class="input-wrap" w-100>
                <textarea name="message" autocomplete="off" class="contact-input mb-3 "> </textarea>
                <label for="message">Message</label>
                <i class="icon fa-solid fa-message" style="color:#007E60;"></i>
        ...
        <div class="right ms-0 ms-md-5">
          <div class="info-wrapper ">
            <h1 style="color: #007e60;">Contact us</h1>
              ...
              <div class="col-lg-4 col-md-4 mb-4 mb-md-0">
                <div class="media d-flex">
                  ...
                  <div class="media-body">
                    ...
                    <a href="tel:919791136945"> <span>+91 91765 69459 </span> </a>
                  </div>
                </div>
              </div>

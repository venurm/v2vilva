...
<div style="overflow:hidden">
    ...
    <div class="welcome row container mx-auto mt-5">
        <div class="tech-img col-12 col-md-6">
        ...
        <div class="tech-des col-12 col-md-6">
            <p style="color: #497DFF;" class="v">Welcome to Vilva Business</p>
    ...
    <div class="  container mx-auto  row">
        <div class="choose  col-12 col-md-5">
            ...
            <h1 style="color: white;font-family: Urbanist;font-size: 48px;">What we do ?</h1>
            <p >
            ...
            <button type="button" class="see">See More</button>
        </div>
            ...
            <div class="service-all">
                <div class="service1">
                    <div class="service p-4"
                        ...
                        <h2>Service 1</h2>
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Illum rem temporibus, ullam ea
                            reprehenderit beatae nulla ratione sed obcaecati</p>
                    </div>
    ...
    <div class="visionn row container mx-auto">
        ...
        <div class="future-con col-12 col-md-6">
            <p style="color: #497DFF;font-family: Urbanist;font-size: 25px ">Our Vision</p>
            ...
            <div class="vision-all">
                <div class="vision1">
                    ...
                    <div class="vision">
                        <h5>Vision 2</h5>
                        <p>Our goal is to innovate and excel, establishing strong alliances with Fortune 500 companies by 2030.</p>
                    </div>
                </div>
                <div class="vision2">
                    <div class="vision">
                        <h5>Vision 3</h5>
                        <p>We envision leading the IT consulting industry, partnering with Fortune 500 giants by 2030.
                        </p>
                    </div>
                    <div class="vision">
                        <h5>Vision 4</h5>
    ...
    <div class=" client-bg">
        <div class=" row container clientboxmove mx-auto">
            <div class="client-box col-12 col-md-3">
                <p style="color: #56FFBD; font-family: Urbanist;font-size: 25px;">Our Client</p>
                <h6>We Work with <br> 30 Clients</h6>
                <p style="color: white;">

                    We proudly collaborate with 30 diverse clients across various industries.  
 ...
 <div class="client-bg-des d-none d-md-block">
                <p style="color: white;font-family: Montserrat;">We are honored to partner with 30 unique clients, delivering tailored <br> solutions  and outstanding service across multiple sectors.</p>

                <button type="button" class="client-btn">Read More</button>
            </div>
            </div>
            </div>
    ...
    <div class="industries row container mx-auto">
        <div class="mobile-img col-12 col-md-5"></div>
        <div class="industries-des col-12 col-md-7">
            ...
            <p
                style="color: #040E56;font-family: Urbanist; font-size: 56px; font-style: normal;font-weight: 700;line-height: 56px; ">
                Why Us?</p>
  ...
  <div class="swiper mySwiper ">
    <div class="swiper-wrapper carousel ">
        ...
        <div class="swiper-slide">
            <div class="testi-container">
                               <div class="">
                                   <img src="{{ asset('internal/images/Iconcar.png') }}" alt="">
      ...
      <div class="swiper-slide">
        <div class="testi-container">
                           <div class="">
                               ...
                               <div class="testi-profile d-flex items-center ">
                                   <div class=" pe-4">
                                       <img class="test-img"  src="{{ asset('internal/images/client.jpg') }}" alt="">
                                   </div>
                                   <div class="">
                                       <p>Manikandan</p>
      ...
      <div class="swiper-slide">
        <div class="testi-container">
                           <div class="">
                               <img src="{{ asset('internal/images/Iconcar.png') }}" alt="">
                               <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit, fugit
                                   accusantium obcaecati culpa, cupiditate, laudantium eius officiis!</p>
                               <div class="testi-profile d-flex items-center ">
                                   <div class=" pe-4">
                                       <img src="{{ asset('internal/images/client.jpg') }}" class="test-img"  alt="">
                                   </div>
                                   <div class="">
                                       <p>Shyni</p>
                                       <p>desognation</p>
    ...
    <div class="intresting">
        <div class="keyboard-img">
            <div class="intresting-des">
                <p>Like what you’ve seen? Get in touch to learn more</p>
                <h5>Intresting with us ?</h5>
                <button type="button" class="touch-btn">Get In Touch Now</button>
            </div>
        </div>
    </div>

...
<body>
    ...
    <div class="tech-heading">
        <h1 style="color: #007e60;">Cutting-Edge Technologies for a Smarter Futuresdsdsds</h1>
    ...
    <script>
        var swiper = new Swiper(".mySwiper", {
            spaceBetween: 30,
            centeredSlides: true,
            slidesPerView: "auto", // Set to "auto" to control the number of slides to be shown based on container width
            loop: true, // Enable loop mode to ensure the swiper continues infinitely
            autoplay: {
                delay: 15500,
            ...
            breakpoints: {
                ...
                1200: {
                    slidesPerView: 3, // Adjust the number of slides to be shown in desktop view
                    spaceBetween: 40,
                    centeredSlides: false // Disable centeredSlides in larger screens
                }
